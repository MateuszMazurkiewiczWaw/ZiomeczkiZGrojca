...
if (isset($_FILES['image']['name'])) {
    ...
    $uploaddir = $_SERVER['DOCUMENT_ROOT'] . '/ZiomeczkiZGrojca/assets/images/profile_pics';
    //Set File name
    ...
    if ($_FILES["image"]["type"] == "image/gif") {
        ...
        $msg .= "Wystapil blad podczas uploadu pliku. Prosze zalaczyc plik z rozszerzeniem .jpg, .gif lub .png. <br />";
    }
...
?>
<div id="Overlay"
     style=" width:100%; height:100%; border:0px #990000 solid; position:absolute; top:0px; left:0px; z-index:2000; display:none;"></div>
<div class="main_column column">
    ...
    <div id="formExample">
        ...
        <form action="upload.php" method="post" enctype="multipart/form-data">
            Zaladuj plik<br/><br/>
            <input type="file" id="image" name="image" style="width:230px; height:30px; "/><br/><br/>
            <input type="submit" value="Zaladuj" style="width:85px; height:25px;"/>
        </form>
        <br/><br/>
    ...
    if ($imgSrc) {
        ...
        <div id="CroppingContainer"
            ...
            <div id="CroppingArea"
                 style="width:500px; max-height:400px; position:relative; overflow:hidden; margin:40px 0px 40px 40px; border:2px #666 solid; float:left;">
                <img src="<?= $imgSrc ?>" border="0" id="jcrop_target"
                     style="border:0px #990000 solid; position:relative; margin:0px 0px 0px 0px; padding:0px; "/>
            </div>

            <div id="InfoArea"
                 style="width:180px; height:150px; position:relative; overflow:hidden; margin:40px 0px 0px 40px; border:0px #666 solid; float:left;">
                <p style="margin:0px; padding:0px; color:#444; font-size:18px;">
                    <b>Przytnij swoje zdjecie profilowe</b><br/><br/>
                    <span style="font-size:14px;">
	                    Przytnij / rozszerz awatara swojego profilu. <br/>
                        Kliknij Zapisz jak tylko osiagniesz zakladany efekt.
            ...
            <div id="CropImageForm" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;">
                <form action="upload.php" method="post" onsubmit="return checkCoords();">
                    ...
                    <input type="submit" value="Zapisz" style="width:130px; height:30px;"/>
                </form>
            </div>
            ...
            <div id="CropImageForm2" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;">
                <form action="upload.php" method="post" onsubmit="return cancelCrop();">
                    <input type="submit" value="Anuluj Przycinanie" style="width:130px; height:30px;"/>
                </form>
            </div>
